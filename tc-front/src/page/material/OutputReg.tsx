...
function OutputReg() {
    ...
    const columns: GridColDef[] = [
        { field: 'materialInputNo', headerName: '입고번호', width: 180, headerAlign: 'center', align: 'center' },
                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Box sx={{paddingRight: 2}}>
                                <ExcelBtn mappingdata={excelData} sheetName="원자재 출고 등록" fileName="원자재 출고 등록" />
                            </Box>
                        </Box>
